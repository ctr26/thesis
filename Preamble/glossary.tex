...
\glsxtrnewsymbol[description={Spot size of \gls{Gaussian beam}}]{omega_0}{\ensuremath{\omega_0}}
...
\glsxtrnewsymbol[description={\(3\times\3\) matrix containing coordinates from \gls{T} }]{T_times}{\ensuremath{\mathbf{T_\times}}}
...
\newglossaryentry{producer-consumer architecture}{
    ...
    description={Producer, programming DEFINE}
}
...
\newglossaryentry{queueing architecture}{
    ...
    description={queueing architecture DEFINE}
}
\newglossaryentry{race conditions}{
    name={race conditions},
    description={race conditions DEFINE}
}
...
\newglossaryentry{exposure}{
    name={exposure},
    description={exposure time $\time$ gain}
}
\newglossaryentry{background signal}{
    name={background singal},
...
\newglossaryentry{essential matrix}{
    ...
    description={\(3\times3\) matrix which relates corresponding points in stereo image pairs in calibrated cameras}
}
\newglossaryentry{fundamental matrix}{
    name={fundamental matrix},
    description={\(3\times3\) matrix which relates corresponding points in stereo image pairs}
}
...
\newacronym{HSV1}{HSV1}{Herpes Simplex Virus 1}
% \newacronym{LWD}{LWD}{Long Working Distance}
