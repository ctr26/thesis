...
Approaches to the linking of detected particles include simple nearest-neighbour\cite{crocker_methods_1996} which assigns lineage to the nearest detected particle in the following frame, making it susceptible to misassignment in the case of occlusions.
