...
For axial particle tracking using light-sheet microscopy, precise axial localisation is needed.
...
The result is that there in an overall axial asymmetry in the PSF, for point sources this allows axial position to be encoded in the recorded image.
...
Assuming an accurate localisation in 2D of a point emitter, the image of the astigmatic point emitter needs to then be compared to a calibrated sample.
...
A computational expensive and slow techniques to recover axial position is fitting a 2D Gaussian.
...
\section{Motion induced astigmatic axial localisation error}
