...
Cell shape strain accounts for a small fraction of tissue strain rate (Figure \ref{fig:cell_tracking}.G), and does not correlate with $\nu$1 ($R^_\text{front}^2 = 0.345$, $p = 0.21$; ($R^_\text{rear}^2 = -0.052$, $p = 0.85$).
