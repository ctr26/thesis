...
\begin{figure}
  ...
  0 hours - Zygote: Cytoplasm streams toward the animal pole to form the blastodisc.
  0.75 - Cleavage: The blastodisc undergoes several rounds of rapid, synchronous, partial cleavage to give 64 blastomeres (and a yolk cell).
  2.25 - Blastula: The midblastula transition occurs. Epiboly begins.
  5.25 - Gastrula: Further cell migration (gastrulation: involution, convergence, extension) forms the epiblast and hypoblast.
  10 - Segmentation: Somites develop. Organogenesis starts. The tail appears.
  24 - Pharyngula: The body axis straightens. Circulation begins and pigmentation develops. Fins begin development.
  48 - Hatching: Primary organ systems complete morphogenesis. Cartilage develops. Hatching occurs.
  72 - Early larva: The swim bladder inflates. Food-seeking behaviour appears.
  }
\end{figure}
...
Cell shape strain accounts for a small fraction of tissue strain rate (Figure \ref{fig:cell_tracking}.G), and does not correlate with $\eta_$ ($R^_\text{front}^2 = 0.345$, $p = 0.21$; ($R^_\text{rear}^2 = -0.052$, $p = 0.85$).
...
When we measure those rheological parameters by magnetic bead displacement, we confirm these predictions: DNRAC embryos fail to increase stiffness and viscosities $\eta_$ and $\eta_2$ ($p_E = 1.016e-09$, $p_{\eta_1}$ = 1.87e-04, $p_{\eta_2}$ = 0.0028) while DNROCK embryos become stiffer and more viscous (pE = 7.59e-25, p$\eta_$ = 6.74e-15, p$\eta_2$ =3.65e-12) than their WT counterparts (Figure 4.F-H).
...
Stiffness E is strongly correlated with initial cell shape deformation while $\eta_$ is strongly correlated with cell rearrangements.
