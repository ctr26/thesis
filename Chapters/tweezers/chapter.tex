...
Bulk tissue properties can be estimated using atomic force microscopy to investigate a tissue surface~\cite{serwane2016invivo}.
...
More recently, techniques have been developed to measure tissue stress and viscoelastic properties, utilising laser ablation~\cite{17}, oil droplets~\cite{serwane2016invivo}, or embedding tissue explants in matrix gel~\cite{16}.
Most recently, ferrofluid droplets have shown that local tissue properties change with respect to the tissue localisation~\cite{serwane2016invivo}. %ROX [, in terms of rheological parameters of elasticity and viscosity? Elaborate on these changes.]
...
\\
The work done in this section is currently under review with \emph{Nature Materials}
\clearpage
...
Cells became more compressed and moved out of the imaging plane (decreasing in area) in front of the bead and, conversely, cells became stretched and entered  the plane at the rear (\figurename~\ref{fig:cell_tracking}a and \figurename~\ref{fig:cell_tracking}b).
...
\(p_{\gls{eta_2_visc}} = \SI{3.65e-12}{}\)) than their \gls{WT} counterparts (\figurename~\ref{fig:cell_tracking}f-\ref{fig:cell_tracking}h) %ROX which?
