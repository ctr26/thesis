...
The first of which required the system to image Zebrafish embryos (\SI{\sim100}{\micro\meter}), surrounded by a magnetic tweezer system, during development (see Chapter \ref{chapter:tweezers}); this was for the study of developmental mechanobiology.
...
\begin{itemize}
    ...
    \item Multi-colour volumetric image
...
%All signals controlling and sychronising the mirrors were generated by a ... %TODO
...
The virtual slit for confocal slit scanning was addressed in the camera's hardware directly using hex address 400210, mode 1 sets the camera to full frame and mode 12, slit scanning.
...
The limiting step for speed was the filter wheel, but multi-notch filters were available for bespoke cases needed maximal colour switching speed.% be used in bespoke cases
