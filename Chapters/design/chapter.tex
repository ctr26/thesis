...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \caption{\gls{CAD} model of \gls{light-sheet} microscope from the top, gravity is going through the page}\label{fig:soldiworks_top}
...
\begin{figure}
  ...
  \end{subfigure}
  \caption{Preliminary images of zebrafish expressing \gls{GFP} and produced from the light-sheet microscope designed and built in this work.}\label{fig:zfish_pretty}
\end{figure}
