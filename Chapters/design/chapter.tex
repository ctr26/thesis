...
They beams were combined %into an overlapping beam using a set of standard dielectric mirrors and dichroic mirrors.
...
Meaning that at \SI{62.5}{\times} magnification, the system is sampled sufficiently for Nyquist criterion (\SI{155.55 nm}{\nano\meter}) which states that the sampling of a system needs be twice the bandwidth of a band-limited signal.
