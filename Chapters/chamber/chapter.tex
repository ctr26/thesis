...
\begin{figure}
    ...
    \caption{The combined solid angles of two objectives must not exceed \SI{180}{\degree} in the plane of orthogonality of the objectives.}\label{fig:solid_angles}
\end{figure}
\begin{figure}
    \centering\hfill
...
\begin{figure}
  ...
  Sensor resolution: \SI{2592x1944}{\text{pixels}} |
...
% Once an embryo is embedded in its agarose tubing it may be transported conveniently, for imaging; it should then be adhered to a 25 mm2 coverslip using epoxy at each end of the tubing whilst avoiding the activate imaging area along the FEP tubing.
...
\begin{figure}
    ...
    \caption[Two colour imaging of a transgenic \gls{zebrafish} 24 h.p.f.]{Raw, optical, two-colour, slice, image of a transgenic \gls{zebrafish} \SI{24}{\text{h.p.f.}}
