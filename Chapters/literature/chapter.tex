...
Equation~\eqref{eq:GuasianBeam} models the Gaussian beam approximation where the full-width half-maximum ($\sqrt{\ln(2)}\omega(z)$) %\mynote[inline]{check maths}
...
\begin{figure*}
	...
	\includegraphics[width=0.8\linewidth]{./exotic_beams}
    \caption{}
\end{figure*}
