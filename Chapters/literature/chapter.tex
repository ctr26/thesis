...
A vertical orientation is attractive as it can be compatible with commercial optical microscopes as well the chamber not requiring an inbuilt detection objective~\cite{schlegel-zawadzkaFluorescenceImagingSpectroscopy1997} \cite{ALEKS 30}.
...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.4\textwidth}
        ...
        \caption{Single detection, single illumination~\cite{wuInvertedSelectivePlane2011a}}
