...
By assuming that a multi-mode fibre operates deterministically on an input light source, they were able to homogenise the illumination output of the fibre using an \gls{SLM}.
