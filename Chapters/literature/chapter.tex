...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.4\textwidth}
        ...
        \caption{Single detection, single illumination}
        \label{fig:depth/ispim}
    \end{subfigure}
    \hspace{0.07\textwidth}
    \begin{subfigure}[t]{0.4\textwidth}
        \centering
        \includegraphics{depth/spin_spim}
        \caption{Single detection, single illumination, with sample rotation}
    ...
    \begin{subfigure}[t]{0.4\textwidth}
        ...
        \caption{Dual detection, dual illumination}
        \label{fig:depth/ispim}
    \end{subfigure}
    \begin{subfigure}[t]{0.4\textwidth}
        \centering
        \includegraphics{depth/di_spim}
        \caption{Single detection, single illumination, with alternate illumination and detection}
