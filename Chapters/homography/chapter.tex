...
$V$ refers to the input calibration voltages of the galvanic mirrors for the \gls{FOV} and $V'$ is the resultant voltage for a given $x$ (normalised) and $z$ which are the desired voltages for creating the \glslink{homography}{homographic} \gls{light-sheet}.
