...
The algorithm presented will use an extension of the projective mathematics discussed in Chapter \ref{chapter:homography}.%TODO insert chapter.
The projective mathematics introduced in Chapter \ref{chapter:homography} can be used for %TODO THISISISI
