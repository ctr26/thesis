...
For a detector with \SI{6}{\micro\meter} pixels, a magnification on the order of $50\times$ is sufficient for diffraction limited imaging using visible light.\index{magnification}
Magnifications in excess of this limit are deemed \emph{empty magnification} and decrease the overall \gls{SNR} of the recorded image.\index{signal to noise ratio}
